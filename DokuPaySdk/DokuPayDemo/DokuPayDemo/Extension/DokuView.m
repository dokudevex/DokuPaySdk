...
- (void)xibSetup {
    UIView *view = [[[UINib nibWithNibName: NSStringFromClass([self class])
                                    bundle: [NSBundle bundleForClass:self.class]] instantiateWithOwner: self options: nil] firstObject];
